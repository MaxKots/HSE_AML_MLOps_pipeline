...
def test_training_pipeline_returns_metrics() -> None:
...
assert "best_valid_metrics" in summary
assert summary["best_model_type"] == "lightgbm"
assert summary["best_valid_metrics"]["roc_auc"] >= 0.5
